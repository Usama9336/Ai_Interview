      ...
      <main className="container mx-auto px-8 mt-20 h-screen">
        <div className="flex grid-cols-12 gap-8 items-center justify-center">
          ...
          <div className="col-span-12 lg:col-span-6 relative flex flex-col items-center justify-center">
            ...
            <label
    htmlFor="file-upload" 
    className="cursor-pointer px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white hover:from-blue-700 hover:to-purple-700 transition-colors"
  >
    Upload Resume
  </label>
  <input 
    id="file-upload" 
    type="file" 
    className="hidden" // This hides the actual input
  />
   <Link href="/nextpage">
              <button className="px-8 py-3 border border-white rounded-full hover:bg-white hover:text-black transition-colors">
                Attempt Interview
              </button>
              </Link>
            </div>
